...
public class SAConfettiView: UIView {
    ...
    public func startConfetti() {
        ...
        emitter.emitterPosition = CGPoint(x: frame.size.width / 2.0, y: -5)
...
//            imagePut.animationImages = testImage?.images
//            imagePut.animationRepeatCount = 0
//            imagePut.image = nil
//            imagePut.startAnimating()
